...
export class ImagenService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/imagens';
    ...
    search(req?: any): Observable<HttpResponse<Imagen[]>> {
        const options = createRequestOption(req);
        return this.http.get<Imagen[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Imagen[]>) => this.convertArrayResponse(res));
    }
