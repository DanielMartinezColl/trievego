...
import com.edu.um.programacion2.service.dto.UsuarioDTO;
...
public class UsuarioResource {
    ...
    public UsuarioResource(UsuarioService usuarioService, UserService userService) {
        this.usuarioService = usuarioService;
        this.userService = userService;
    }

    /**
     * POST  /usuarios : Regsitrar a new usuario.
     *
    ...
    @Timed
    public ResponseEntity<Usuario> registrarUsuario(@RequestBody UsuarioDTO usuarioDTO) throws URISyntaxException {
        ...
        User user = userService.registerUser(userDTO, usuarioDTO.getPassword());
        ...
        Usuario usuarioregistrar =  usuarioService.save(usuario);
  
        return ResponseEntity.created(new URI("/api/usuarios/" + usuarioregistrar.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(ENTITY_NAME, usuarioregistrar.getId().toString()))
            .body(usuarioregistrar);
    }
