...
public class ProvinciaResource {
    ...
    public ProvinciaResource(ProvinciaRepository provinciaRepository, ProvinciaSearchRepository provinciaSearchRepository) {
    ...
    public ResponseEntity<List<Provincia>> searchProvincias(@RequestParam String query, Pageable pageable) {
        ...
        Page<Provincia> page = provinciaSearchRepository.search(queryStringQuery(query), pageable);
