...
import com.edu.um.programacion2.repository.search.UsuarioSearchRepository;
...
public class UserService {
    ...
    @Inject
	private UsuarioSearchRepository UsuarioearchRepository;
    ...
    public User registerUser(UserDTO userDTO, String password, LocalDate fechaNacimiento, Genero genero) {
        ...
        System.out.println(newUsuario.getGenero());
        System.out.println(newUsuario.getFechaNacimiento());
        System.out.println(newUsuario.getUser());
	...
	public User registerUser(ManagedUserVM managedUserVM, String password, Genero genero) {
		return null;
	}
