...
public class TagResourceIntTest {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getNombre()).isEqualTo(DEFAULT_NOMBRE);
        assertThat(testTag.isEstado()).isEqualTo(DEFAULT_ESTADO);
    ...
    public void updateTag() throws Exception {
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getNombre()).isEqualTo(UPDATED_NOMBRE);
        assertThat(testTag.isEstado()).isEqualTo(UPDATED_ESTADO);
