...
import com.edu.um.programacion2.service.CategoriaService;
...
public class CategoriaResourceIntTest {
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.isEstado()).isEqualTo(DEFAULT_ESTADO);
    }
    ...
    public void updateCategoria() throws Exception {
        ...
        assertThat(testCategoria.isEstado()).isEqualTo(UPDATED_ESTADO);
    }
