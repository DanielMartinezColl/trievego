...
class EventoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Evento entity")
        ...
        .repeat(2) {
            ...
            .post("/api/eventos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nombre":"SAMPLE_TEXT", "resumen":"SAMPLE_TEXT", "descripcion":"SAMPLE_TEXT", "precio":"0", "fechaHora":"2020-01-01T00:00:00.000Z", "direccion":"SAMPLE_TEXT", "imagen":null}""")).asJSON
            .check(status.is(201))
